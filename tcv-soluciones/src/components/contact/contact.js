...
const Contacto = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-6xl mx-auto p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
        <div>
          <label htmlFor="tipoTrabajo" className="block text-sm font-medium text-gray-700">Tipo de Servicio</label>
          <select
            id="tipoServicio"
            name="tipoServicio"
          ...
          >
            ...
            <option value="Diseño y Creación de Paginas Web">Diseño y Creacion de Pagina Web</option>
            <option value="Mantenimiento de Hardware">Mantenimiento de Hardware</option>
            <option value="Formateo de PC">Formateo de PCs</option>
            <option value="Reemplazo e Instalación de Hardware">Reemplazo e Instalación de Hardware</option>
            {/* Agrega aquí las opciones necesarias */}
          </select>
        </div>       

        <div>
          <label htmlFor="modalidad" className="block text-sm font-medium text-gray-700">Modalidad de Atención</label>
          <select
            id="modalidad"
            name="modalidad"
            ...
            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
          >
            <option value="" disabled={true}>-- Seleccione modalidad --</option>
            <option value="Instalación de Sistema Operativo">Presencial</option>
            <option value="Instalación de Programas">Remoto</option>
